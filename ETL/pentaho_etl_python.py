...
DB_URL = "postgresql://postgres:2210510@localhost:5432/warehouse"
engine = create_engine(DB_URL, echo=False)

# DATA_PATH = r"d:\Code\BTL\Data mining\Fraud detection\data"
DATA_PATH = r"C:\University\Ki252_KHMT\Datamining\overview\DataM-DataW\Data\archive"
...
def create_dim_customer():
    ...
    try:
        ...
        # Table Output
        df.to_sql('dim_customer', con=engine, if_exists='append', index=False, chunksize=5000)
...
def create_dim_merchant():
    ...
    try:
        ...
        # Table Output
        df.to_sql('dim_merchant', con=engine, if_exists='append', index=False, chunksize=5000)
...
def create_dim_location():
    ...
    try:
        ...
        # Table Output
        df.to_sql('dim_location', con=engine, if_exists='append', index=False, chunksize=5000)
...
def create_dim_time():
    ...
    try:
        ...
        # Table Output
        df.to_sql('dim_time', con=engine, if_exists='append', index=False, chunksize=5000)
